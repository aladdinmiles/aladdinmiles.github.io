...
export const QRCode: React.FC<{ width: string; height: string }> = ({ height, width }) => (
  <svg fill="#ffffff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${width} ${height}`}>
    <g>
      <g>
