  ...
  [489, 160],
  {
    ...
    431: function (t, n, e) {
      ...
      let w = h.Z.div({ width: '100%', minHeight: '100%', backgroundColor: '#ffffff' }),
        ...
        F = h.Z.h1([r().style, { fontSize: (0, d.JB)(44), color: '#1D2029' }]),
        _ = h.Z.span({ color: '#FF1453' }),
        C = h.Z.div({
          margin: ''
            .concat((0, d.Wk)(168), ' ')
            .concat((0, d.so)(24), ' ')
        ...
        I = (0, h.Z)(B)({ color: '#515665', fontSize: (0, d.JB)(22), lineHeight: '160%' }),
        N = h.Z.div({
          display: 'flex',
          flexDirection: 'row',
          gap: (0, d.so)(24),
        ...
        V = (0, h.Z)(I)([u().style, { color: '#ffffff', fontSize: (0, d.JB)(32) }]),
        E = (0, h.Z)(I)({ color: '#ffffff', textAlign: 'center', width: (0, d.so)(440), fontSize: (0, d.JB)(24) }),
        O = h.Z.section({
