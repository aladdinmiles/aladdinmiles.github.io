  ...
  [872],
  {
    ...
    4914: function (e, t, n) {
      ...
      let r = i.Z.div({
          ...
          display: 'flex',
          flexDirection: 'row',
          padding: ''.concat((0, o.Wk)(100), ' ').concat((0, o.so)(80)),
          alignItems: 'center',
          justifyContent: 'space-between',
          '& img': { width: (0, o.so)(616), height: (0, o.so)(600), objectFit: 'cover', objectPosition: 'center' },
          ...(0, o.wz)({
            flexDirection: 'column',
            padding: ''.concat((0, o.$s)(40), ' ').concat((0, o.CD)(24)),
            alignItems: 'flex-start',
            textAlign: 'center',
            gap: (0, o.$s)(40),
            '& img': { width: (0, o.CD)(414), height: (0, o.CD)(404), objectFit: 'cover', objectPosition: 'center' }
          })
        }),
        c = i.Z.div([
          '\n  display: inline-flex;\n  flex-direction: column;\n  align-items: flex-start;\n  gap: '
            .concat((0, o.Wk)(40), ';\n  width: ')
            .concat((0, o.so)(560), ';\n'),
          (0, o.wz)({ alignItems: 'center', width: '100%' })
        ]),
        s = i.Z.div([
          '\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  gap: '.concat(
            (0, o.Wk)(16),
          ...
          (0, o.wz)({ '& .small': { textAlign: 'center', width: '100%' } })
        ]),
        l = i.Z.div({
          ...
          gap: (0, o.so)(54),
          justifyContent: 'space-between',
          '& img': { width: (0, o.so)(586), height: (0, o.so)(600), objectFit: 'cover', objectPosition: 'center' },
          ...(0, o.wz)({
    ...
    750: function (e, t, n) {
      ...
      let d = (e) => {
          ...
          return (0, o.jsx)(f, { href: n, children: (0, o.jsx)(g, { className: r().className, children: t }) });
        },
        f = (0, s.Z)(a())({
