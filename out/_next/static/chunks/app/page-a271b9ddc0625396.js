  ...
  [931],
  {
    ...
    3839: function (t, n, e) {
      ...
      let w = u.Z.section({
        ...
        C = u.Z.div({ display: 'flex', flexDirection: 'column', gap: (0, f.Wk)(12), width: (0, f.so)(329) }),
    ...
    431: function (t, n, e) {
      ...
      let w = h.Z.div({ width: '100%', minHeight: '100%', backgroundColor: '#ffffff' }),
        ...
        W = h.Z.h1([r().style, { fontSize: (0, d.JB)(44), color: '#1D2029' }]),
